...
void Bank::choice(){
	...
	cout<<"\n           Hi, Choose From The Available Services."<<endl;

	cout<<"\n"<<endl;

	cout<<"             1. Create New Account"<<endl;

	cout<<"             2. View Details Of All The Customers"<<endl;

	cout<<"             3. Update Details Of Existing Customer"<<endl;

	cout<<"             4. Check Details Of Individual Customer"<<endl;

	cout<<"             5. Transactions"<<endl;

	cout<<"             6. Delete Account Of Existing Customer"<<endl;
